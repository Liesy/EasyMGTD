"""
Debug script for the ChatGPT-D detection method.

Experiment type: supervised
ChatGPT-D uses a pre-trained RoBERTa-based detector from Hello-SimpleAI.
It runs inference only (need_finetune=false).

Usage:
    cd <project_root>
    python run/debug/test_chatgpt_d.py
"""
