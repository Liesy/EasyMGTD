"""
Debug script for the LRR (Log-Rank Ratio) detection method.

Experiment type: threshold
This method uses log-rank ratio statistics from a base LM for detection.

Usage:
    cd <project_root>
    python run/debug/test_lrr.py
"""
