"""
Debug script for the NPR (Normalized Perturbed Rank) detection method.

Experiment type: perturb
NPR compares token ranks before and after text perturbation.

Usage:
    cd <project_root>
    python run/debug/test_npr.py
"""
