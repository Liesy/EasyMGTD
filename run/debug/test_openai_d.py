"""
Debug script for the OpenAI-D detection method.

Experiment type: supervised
OpenAI-D fine-tunes a pre-trained model (e.g. DistilBERT) for binary detection.

Usage:
    cd <project_root>
    python run/debug/test_openai_d.py
"""
